...
functional_patch1 = cowplot::plot_grid(pleiotropy_outputs$tau_demo,
                                       pleiotropy_outputs$centrality_combined +
                                         theme_minimal(),ncol = 1,labels = c("A","B"),label_size = 32,vjust = c(1.5,-0.6),rel_heights = c(0.8,1))
functional_patch1
...
functional_patch2 = cowplot::plot_grid(pleiotropy_outputs$pleiotropy_results_fig,
                                       ...
                                       ncol = 1,labels = c("C",""),label_size = 32,rel_heights = c(0.7,1),vjust = c(1.4,0))
functional_patch2

# Merge
pdf('figs/Figure4_pleiotropy_and_convergence_results.pdf',width = 16,height = 8)
