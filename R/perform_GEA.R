...
metadata <- read.csv("metadata/sample_species_vcf_author_map_v2_21,05,04.csv")
...
cline_corrs <- mclapply(1:length(climate_vars),function(x){
  ...
  cor_res <- pbapply::pblapply(1:length(winds),function(y){
